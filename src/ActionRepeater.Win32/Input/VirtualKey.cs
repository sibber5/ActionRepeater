...
public enum VirtualKey : ushort
{
    ...
    /// </summary>
    [Obsolete("Use VirtualKey.HANGUL instead")]
    HANGEUL = 0x15,
    ...
    /// <summary>Reserved (for UI navigation)</summary>
    ...
    /// </summary>
    /// <remarks>For more information, see Remark in <see cref="KEYBDINPUT"/>, <see cref="PInvoke.SendInput(uint, INPUT*, int)"/>, <see cref="WindowMessage.KEYDOWN"/>, and <see cref="WindowMessage.KEYUP"/></remarks>
    PACKET = 0xE7,
