...
public sealed partial class HomeViewModel : ObservableObject
{
    ...
    public HomeViewModel(CoreOptions coreOptions, PathWindowService pathWindowService, DrawablePathWindowService drawablePathWindowService, ActionCollection actionCollection, ActionListViewModel actionListVM, Player player, Recorder recorder, IDispatcher dispatcher, IDialogService dialogService)
    {
